...
import {truncateDescription, truncateDescriptionHome} from "../utils/truncateDescription";
            ...
            <Layout>
                ...
                <div className="grid gap-5 mb-10 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                    {objTest.map((item, index) => (
                        ...
                        >
                            <CardProduct
                                nameProduct={truncateDescriptionHome("Nike Air Jordan 1", 20)}
                                description={truncateDescriptionHome("Đến 10h ngày 7/9, tâm bão ở bắc vịnh Bắc Bộ, cách Quảng Ninh khoảng 120 km, sức gió giảm còn cấp 13, giật cấp 16, vẫn rất mạnh. Với sức gió này, nhà mái tôn bị thổi bay nóc, tường bao có thể đổ. Bão sau đó đi vào các tỉnh Quảng Ninh - Ninh Bình và suy yếu thành áp thấp nhiệt đới.", 70)}
