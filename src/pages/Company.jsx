        ...
        <div className="mt-8 mb-8">
          <div className="flex justify-between mb-2">
            ...
            <p className="text-black text-xs">
              ...
              <br /> fact that reader will be distracted
            </p>
          </div>
          ...
          <div className="flex justify-between gap-4 my-4">
            <div className="w-1/3 p-20 text-center bg-blue-50 rounded-md ">
              <h1 className=" text-xl font-bold">10+</h1>
              <p className=" text-xs ">yrars of service</p>
            </div>
            <div className="w-1/3 p-20 text-center bg-blue-50 rounded-md ">
              <h1 className=" text-xl font-bold">20K</h1>
              <p className=" text-xs ">happy customers</p>
            </div>
            <div className="w-1/3 p-20 text-center bg-blue-50 rounded-md ">
              <h1 className=" text-xl font-bold">94%</h1>
              <p className=" text-xs ">customer satisfaction</p>
            </div>
          </div>

          <div className="flex justify-between gap-6">
            <div className="w-1/3 px-16 py-10 rounded-md border border-gray-300 text-center flex flex-col items-center">
              <div className="mb-4">
                <StrategyIcon/>
              </div>
              <h1 className="font-bold text-xl mb-2">Strategy</h1>
              <p className="text-xs mb-4">
                There are many variations opassage of Lorem Ipsum available, but
                the majority have suffered aeratio.{' '}
              </p>
            ...
            <div className="w-1/3 px-16 py-10 rounded-md bg-blue-400 border border-gray-300 text-center flex flex-col items-center">
              <div className="mb-4 ">
                <TechnologyIcon/>
              </div>
            ...
            <div className="w-1/3 px-16 py-10 rounded-md border border-gray-300 text-center flex flex-col items-center">
              ...
              <p className="text-xs mb-4">
                There are many variations opassage of Lorem Ipsum available, but
                the majority have suffered aleratio.{' '}
              </p>
              <a className="font-bold text-blue-400" href="#">
                Learn More
              </a>
