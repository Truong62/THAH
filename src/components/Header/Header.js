...
const Header = () => {
  return (
    <div
      className={`container flex flex-col mx-auto sticky top-0 left-0 right-0 z-50 bg-white`}
    >
      <div className="relative flex flex-wrap items-center justify-between w-full  group py-7 shrink-0">
        ...
        <div className="items-center hidden gap-8 md:flex">
          ...
          <button className="flex items-center px-4 py-2 text-sm font-bold rounded-xl bg-purple-blue-100 text-purple-blue-600 bg-blue-500 text-white">
            Sign Up
          </button>
        </div>
