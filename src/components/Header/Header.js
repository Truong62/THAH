    ...
    return (
        <div className={`container flex flex-col mx-auto sticky top-0 left-0 right-0 z-50 bg-white`}>
            <div className="relative flex flex-wrap items-center justify-between w-full  group py-7 shrink-0">
                ...
                <div
                    className="absolute flex md:hidden transition-all duration-300 ease-in-out flex-col items-start shadow-main justify-center w-full gap-3 overflow-hidden bg-white max-h-0 group-[.open]:py-4 px-4 rounded-2xl group-[.open]:max-h-64 top-full">
                    <Link to={'/'}
