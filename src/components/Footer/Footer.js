                ...
                <div className="grid gap-8 md:grid-cols-3">
                    <div className="col-span-2 grid gap-8 md:grid-cols-3">
                        ...
                        <div className="col-span-1">
                            ...
                            <p className="mb-4">
                                <Link to={'/'} className="text-[#303030] dark:text-neutral-200">NIKE</Link>
                            </p>
                            <p className="mb-4">
                                <Link to={'/'} className="text-[#303030] dark:text-neutral-200">Adidas</Link>
                            </p>
                            <p className="mb-4">
                                <Link to={'/'} className="text-[#303030] dark:text-neutral-200">Vans</Link>
                            </p>
                            <p>
                                <Link to={'/'} className="text-neutral-600 dark:text-neutral-200">MLB</Link>
                            </p>
                        </div>
                        <div className="col-span-1">
                            <h6 className="mb-4 flex justify-center font-semibold uppercase md:justify-start">
